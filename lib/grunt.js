...
var mutate = function(tree, tests, framework, done) {
...
module.exports = function(cb) {
  fs.exists(GRUNTFILE, function(exists) {
    ...
    findTestCases(function(err, tests, framework) {
      ...
      mutate(ast, tests, framework, function(err, src) {
        npm.load({ 'save-dev': true }, function() {
          npm.commands.install(['grunt-contrib-connect', 'grunt-saucelabs'], function(err, obj) {
            cb(null);
          });
        });
      });
